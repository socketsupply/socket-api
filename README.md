...
* [Bluetooth](#bluetooth)
   * [Bluetooth (extends EventEmitter)](#bluetooth-extends-eventemitter)
      * [constructor(serviceId)](#constructorserviceid)
      * [start()](#start)
...
* [Crypto](#crypto)
   * [webcrypto](#webcrypto)
   * [getRandomValues(buffer)](#getrandomvaluesbuffer)
   * [RANDOM_BYTES_QUOTA](#random_bytes_quota)
   * [MAX_RANDOM_BYTES](#max_random_bytes)
   * [MAX_RANDOM_BYTES_PAGES](#max_random_bytes_pages)
   * [randomBytes(size)](#randombytessize)
   * [createDigest(algorithm, message)](#createdigestalgorithm-message)
* [Dgram](#dgram)
   * [ERR_SOCKET_ALREADY_BOUND (extends SocketError)](#err_socket_already_bound-extends-socketerror)
   * [ERR_SOCKET_DGRAM_IS_CONNECTED (extends SocketError)](#err_socket_dgram_is_connected-extends-socketerror)
   * [ERR_SOCKET_DGRAM_NOT_CONNECTED (extends SocketError)](#err_socket_dgram_not_connected-extends-socketerror)
   * [ERR_SOCKET_DGRAM_NOT_RUNNING (extends SocketError)](#err_socket_dgram_not_running-extends-socketerror)
   * [ERR_SOCKET_BAD_TYPE (extends TypeError)](#err_socket_bad_type-extends-typeerror)
   * [ERR_SOCKET_BAD_PORT (extends RangeError)](#err_socket_bad_port-extends-rangeerror)
   * [createSocket(options, callback)](#createsocketoptions-callback)
   * [Socket (extends EventEmitter)](#socket-extends-eventemitter)
      * [bind(port, address, callback)](#bindport-address-callback)
      * [connect(port, host, connectListener)](#connectport-host-connectlistener)
      * [disconnect()](#disconnect)
      * [send(msg, offset, length, port, address, callback)](#sendmsg-offset-length-port-address-callback)
      * [close(callback)](#closecallback)
      * [address()](#address)
      * [remoteAddress()](#remoteaddress)
      * [setRecvBufferSize(size)](#setrecvbuffersizesize)
      * [setSendBufferSize(size)](#setsendbuffersizesize)
      * [getRecvBufferSize()](#getrecvbuffersize)
      * [getSendBufferSize()](#getsendbuffersize)
* [DNS](#dns)
   * [lookup(hostname, opts, cb)](#lookuphostname-opts-cb)
* [DNS.promises](#dnspromises)
   * [lookup(hostname, opts)](#lookuphostname-opts)
* [File System](#file-system)
   * [access(path, mode , callback)](#accesspath-mode--callback)
   * [chmod(path, mode, callback)](#chmodpath-mode-callback)
   * [close(fd, callback)](#closefd-callback)
   * [copyFile()](#copyfile)
   * [createReadStream(path, options)](#createreadstreampath-options)
   * [createWriteStream(path, options)](#createwritestreampath-options)
   * [fstat(fd, options, callback)](#fstatfd-options-callback)
   * [open(path, flags , mode , callback)](#openpath-flags--mode--callback)
   * [opendir(path, options, callback)](#opendirpath-options-callback)
   * [read(fd, buffer, offset, length, position, callback)](#readfd-buffer-offset-length-position-callback)
...
* [FS.promises](#fspromises)
   * [access(path, mode, options)](#accesspath-mode-options)
   * [open(path, flags, mode)](#openpath-flags-mode)
   * [opendir(path, options)](#opendirpath-options)
...
* [FS.Stream](#fsstream)
   * [DEFAULT_STREAM_HIGH_WATER_MARK](#default_stream_high_water_mark)
   * [ReadStream (extends Readable)](#readstream-extends-readable)
      * [constructor()](#constructor)
      * [setHandle(handle)](#sethandlehandle)
      * [highWaterMark()](#highwatermark)
      * [path()](#path)
      * [pending()](#pending)
      * [emit()](#emit)
   * [WriteStream (extends Writable)](#writestream-extends-writable)
      * [constructor()](#constructor-1)
      * [setHandle(handle)](#sethandlehandle-1)
...
* [IPC](#ipc)
   ...
   * [parseSeq(seq, options)](#parseseqseq-options)
   * [debug(enable)](#debugenable)
   * [Message (extends URL)](#message-extends-url)
      * [PROTOCOL()](#protocol)
      * [from(input, params)](#frominput-params)
      * [isValidInput(input)](#isvalidinputinput)
      ...
      * [get(key, defaultValue)](#getkey-defaultvalue)
      ...
      * [toJSON()](#tojson)
   * [Result](#result)
      * [from(result, maybeError, maybeSource)](#fromresult-maybeerror-maybesource)
      * [constructor(err , data , source )](#constructorerr--data--source-)
      * [length()](#length)
   * [ready()](#ready)
   * [sendSync(command, params)](#sendsynccommand-params)
   * [emit(name)](#emitname)
   * [resolve(seq)](#resolveseq)
   * [send(command)](#sendcommand)
   * [write(command, params, buffer, options)](#writecommand-params-buffer-options)
   * [request(command, params, options)](#requestcommand-params-options)
   * [createBinding(domain, ctx)](#createbindingdomain-ctx)
* [OS](#os)
   * [arch()](#arch)
